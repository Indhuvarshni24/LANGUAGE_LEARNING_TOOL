...
const FrenchLearning = () => {
    ...
    const handleLevelSelection = (level) => {
        ...
        if (level === 'beginner') {
            ...
            navigate('/french/advanced'); // Navigate to the ScenarioPage for advanced level
        }
    };
    ...
    return (
        <div className="french-container">
            ...
            <section className="french-content">
                ...
                <p>French is one of the most widely spoken languages across the world. It opens doors to countless cultures, opportunities, and beautiful regions to visit. Whether you're traveling, working, or studying, mastering French will enrich your experiences.</p>
