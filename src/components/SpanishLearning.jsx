    ...
    return (
        <div className="spanish-container">
            ...
            <section className="spanish-content">
                ...
                <h3>Key Features of Our Spanish Course:</h3>
                <ul>
                    <li>Interactive lessons with engaging exercises.</li>
                    <li>Real-life dialogues to enhance your conversational skills.</li>
                    <li>Quizzes to test your knowledge and track your progress.</li>
                </ul>
            </section>
