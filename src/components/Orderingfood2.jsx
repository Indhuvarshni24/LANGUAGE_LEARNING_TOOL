...
import './OrderingFood2.css'; // Update this CSS file for styling
...
const OrderingFood2 = () => {
    ...
    const questions = [
        {
            question: "आप क्या ऑर्डर करना चाहेंगे?",
            options: ["पिज़्ज़ा", "पास्ता", "सूप", "सलाद"],
            correctAnswer: "पिज़्ज़ा",
            image: "food1.jpg"
        },
        {
            question: "आप क्या पीना चाहेंगे?",
            options: ["पानी", "जूस", "कॉफ़ी", "चाय"],
            correctAnswer: "पानी",
            image: "food2.jpg"
        },
        {
            question: "क्या आपके पास मिठाई है?",
            options: ["हां", "नहीं", "शायद", "मुझे नहीं पता"],
            correctAnswer: "हां",
            image: "food3.jpg"
        }
    ];
        ...
        if (user) {
            try {
                const docRef = await addDoc(collection(db, 'orderingFood'), {
                    ...
                    scenario: "Ordering Food", // Scenario name in Hindi
            ...
            console.error('कोई उपयोगकर्ता लॉग इन नहीं है।');
        }
    };
